function easterEggMode() {
    ...
    if (img2.indexOf("images/avatar.jpg") != -1) {
        ...
        setTimeout(function () {
            document.getElementById("one").style.backgroundImage = "url(images/EasterEgg/banner2.jpg)"
        }, 5500);
    ...
    document.onkeydown = function (event) {
        ...
        if (event.keyCode == 13) {
            if (safe == 1) {
                ...
                setTimeout(function () {
                    img3.src = "images/EasterEgg/nikoNeu.gif"
                }, 3000);
                setTimeout(function () {
                    img3.src = ""
                }, 4199);
                setTimeout(function () {
                    img3.src = "images/EasterEgg/niko1.gif"
                }, 4200);
                setTimeout(function () {
                    safe = 1
                }, 4200);
